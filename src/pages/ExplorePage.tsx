...
import { ArrowLeft, MapPin, Clock, Star, Calendar, Users, Camera } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-2xl p-6">
              ...
              <div className="text-center">
                ...
                <button className="w-full bg-teal-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-teal-700 transition-colors">
                  Book Now
                </button>
